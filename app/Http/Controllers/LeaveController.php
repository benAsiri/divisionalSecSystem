...
class LeaveController extends Controller
{
    ...
    protected function Reject(Request $request)
    {
        ...
        DB::table('leaves')
            ...
            notify()->flash('Leave has been rejected!', 'success');
    ...
    protected function Approve(Request $request)
    {
        ...
        DB::table('leaves')
            ...
            notify()->flash('Leave has been successfully approved!', 'success');
    ...
    protected function addleave(Request $request)
    {
        ...
        if($request['leave_type']=='Casual')
        {
            ...
            if(21 >= $casual_leaves +  $request['nofdayss']  )
            {
                ...
                notify()->flash('Casual Leave request has been added!', 'success');

            }

        else{

            notify()->flash('Too many Casual leave request', 'warning');
...

        {
            ...
            if(24 >= $vacation_leaves +  $request['nofdayss']  )
            {
                ...
                notify()->flash('Vacation Leave request has been added!', 'success');
            }

            else
            {

                notify()->flash('Too many Vacation leave requests', 'warning');
        ...
        else
        {
            ...
            notify()->flash('Leave request has been added!', 'success');
        }
